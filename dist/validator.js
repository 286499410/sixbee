...
var Validator = function () {
    function Validator() {
        ...
        this.setState = function (state) {
            (0, _assign2.default)(_this[_state], state);
        };
        ...
        this.setLabel = function (key, value) {
            if (_lodash2.default.isObject(key)) {
                _this.label = (0, _extends3.default)({}, _this.label, key);
            } else {
                _this.label[key] = value;
            }
        };

        this.parseRule = function (config) {
            if (!(0, _lib2.default)('object').isEmpty(_this[_state].rule)) {
                return _this[_state].rule;
            }
            var rule = {};
        ...
        this.parseMessage = function (config) {
            if (!(0, _lib2.default)('object').isEmpty(_this[_state].message)) {
                return _this[_state].message;
            }
            var message = {};
        ...
        this.parseScene = function (config) {
            if (!(0, _lib2.default)('object').isEmpty(_this[_state].scene)) {
                return _this[_state].scene;
            }
            var scene = {};
            ...
            _this.setState({ scene: scene });
            return scene;
        };

        this.getRule = function (key) {
            var rule = _this.parseRule(_this.rule);
            return rule[key];
        };

        this.check = function (data) {
            var scene = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : _this[_scene];

            var keys = void 0,
                flag = true;
            if (scene === false || !_this.scene[scene]) {
                keys = (0, _keys2.default)(data);
            } else {
                keys = _this.scene[scene];
            }
            var rule = _this.parseRule(_this.rule);
            _this.errorMsg = {};
        ...
        this.validates = function (data, key, validates, label) {
            ...
            try {
                for (var _iterator4 = (0, _getIterator3.default)(validates), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
                    var validate = _step4.value;
            ...
            if (validate.type === 'required' && isEmpty) {
                ...
                switch (validate.type) {
                    ...
                    case '==':
                        ...
                        break;
                    default:
                        if ((0, _lib2.default)('object').isFunction(_this[validate.type])) {
