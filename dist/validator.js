...
var Validator = function () {
    ...
    (0, _createClass3.default)(Validator, [{
        ...
        value: function config(_config) {
            if (_config.rule) this.rule = _config.rule;
            if (_config.message) this.message = _config.message;
            if (_config.scene) this.scene = _config.scene;
            if (_config.label) this.label = _config.label;
        }
    }, {
        key: 'setState',
