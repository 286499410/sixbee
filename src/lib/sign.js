...
let h = 'h', i = 'i', j = 'j', k = 'k', l = 'l', m = 'm', n = 'n';
let o = 'o', p = 'p', q = 'q', r = 'r', s = 's', t = 't';
let u = 'u', v = 'v', w = 'w', x = 'x', y = 'y', z = 'z';

let app = ['5967257d40355d66b', 'c1a980a24ddec339c35e0e78fa7d999a'];
let appid = a + p + p + i + d;
let appkey = a + p + p + k + e + y;
let sign = s + i + g + n;
let timestamp = t + i + m + e + s + t + a + m + p;
